...
public class ItemController {
	...
	@GetMapping(value = ITEM_END_POINT_V1, produces = { "application/json", "application/xml" })
	@ResponseBody
	public Flux<Item> getAllItems(ServerHttpResponse response) {
	...
	public Mono<ResponseEntity<Item>> updatedItem(@PathVariable String id, @RequestBody Item item) {
